...
BEGIN;
INSERT INTO config.upgrade_log (version, applied_to) VALUES ('2.2.4', '2.2.4');

SELECT evergreen.upgrade_deps_block_check('0744', '2.2.4');
...
SELECT evergreen.upgrade_deps_block_check('0746', '2.2.4');
