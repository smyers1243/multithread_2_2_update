...
BEGIN;
INSERT INTO config.upgrade_log (version, applied_to) VALUES ('2.2.3', '2.2.3');

-- 0738.schema.vandelay.import-match-no-like-any.sql

SELECT evergreen.upgrade_deps_block_check('0738', '2.2.3');
...
SELECT evergreen.upgrade_deps_block_check('0740', '2.2.3');
...
SELECT evergreen.upgrade_deps_block_check('0742', '2.2.3');
