...
-- Delete old version of function with different input.
...
--TODO: public.search_normalize doesn't exist
...
-- New function def
DROP FUNCTION IF EXISTS metabib.reingest_metabib_field_entries( BIGINT, BOOL, BOOL, BOOL );
...
--TRIGGERS using function above.  Same name, different tables
