...
----------------------------------
--Begin Catalyst Specific upgrades
----------------------------------
...
-- Function: public.remove_insignificants(text)

-- DROP FUNCTION public.remove_insignificants(text);
...
-- Index: metabib.normalized_remove_insignificants_author_field_entry_gist_trgm

-- DROP INDEX metabib.normalized_remove_insignificants_author_field_entry_gist_trgm;
...
-- Index: metabib.normalized_remove_insignificants_title_field_entry_gist_trgm

-- DROP INDEX metabib.normalized_remove_insignificants_title_field_entry_gist_trgm;
...
-- Index: metabib.normalized_remove_insignificants_subject_field_entry_gist_trgm

-- DROP INDEX metabib.normalized_remove_insignificants_subject_field_entry_gist_trgm;
...
-- Index: metabib.normalized_remove_insignificants_series_field_entry_gist_trgm

-- DROP INDEX metabib.normalized_remove_insignificants_series_field_entry_gist_trgm;
